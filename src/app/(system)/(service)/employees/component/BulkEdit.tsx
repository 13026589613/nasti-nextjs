...
import { batchEdit, getworkerRoleSelect } from "@/api/employees";
...
const BulkEdit = (props: BulkEditProps) => {
  ...
  const addTypeDictinaryFn = async (data: AddTypeEmployeeParams) => {
    ...
    const params: any = {
      ...
      terminationDate:
        terminationDate &&
        localMoment(terminationDate, "MM/DD/YYYY").format("MM/DD/YYYY"),
      hireDate:
        hireDate && localMoment(hireDate, "MM/DD/YYYY").format("MM/DD/YYYY"),
                ...
                >
                  <DatePicker
                    ...
                    disabledDate={(current) => {
                      return current && current > localMoment().startOf("day");
                    }}
                  ></DatePicker>
                </CustomFormItem>
              )}
